...
Check <span style="color:red">~/.ssh/controlmaster/</span> to see if there's any socket in the form of <span style="font-size: 25px; color:white"><b>user@domain:22</span>
