...
With this basic understanding, we can now pass onto analysing the various attack against these mechanisms, starting from the easiest <a href="https://scare.rocks/blog/2022-01-17-Car-Hacking-Part-2:-Replay-Attack.html" style="color:red;">Replay Attack</a>.
